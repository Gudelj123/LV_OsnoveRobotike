...
def task3():
	...
	plt.title("tc,Qc")
	plt.legend(["First Joint","Second Joint","Third Joint","Fourth Joint","Fifth Joint","Sixth Joint"])
	plt.show()
	...
	plt.title("Trajektorija robotske ruke")
	plt.show()
	...
	ax.axis('equal')
	plt.title("Uzorkovane točke koje se nalaze unutar thresholda ravnine")
	plt.show()
